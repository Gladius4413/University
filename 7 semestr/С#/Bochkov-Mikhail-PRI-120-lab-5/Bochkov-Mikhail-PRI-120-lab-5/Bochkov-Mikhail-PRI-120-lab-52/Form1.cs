...
namespace Bochkov_Mikhail_PRI_120_lab_52
{
    public partial class Form1 : Form
    {
        ...
        private void functionCalculation()
        {
            ...
            GrapValuesArray = new double[300, 2];
        ...
        private void DrawDiagram()
        {
            ...
            // выводим красную точку, используя ту ячейку массива, до которой мы дошли (вычисляется в функии-обработчике событий таймера)
        ...
        private void Draw()
        {
            ...
            // каждые две точки, последовательно вызванные коммандой glVertex,
            // объединяются в линию
