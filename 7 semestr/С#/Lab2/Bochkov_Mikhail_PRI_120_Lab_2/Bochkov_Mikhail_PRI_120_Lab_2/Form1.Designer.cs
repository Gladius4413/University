namespace Bochkov_Mikhail_PRI_120_Lab_2
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            label1.Location = new Point(212, 72);
            label1.Name = "label1";
            label1.Size = new Size(403, 25);
            label1.TabIndex = 0;
            label1.Text = "Вы стремитесь сделать мир лучше?\r\n";
            ...
            // button1
            // 
            button1.Location = new Point(162, 137);
            button1.Name = "button1";
            button1.Size = new Size(95, 33);
            button1.TabIndex = 3;
            button1.Text = "Да, конечно!";
            button1.UseVisualStyleBackColor = true;
            button1.Click += button1_Click;
            // 
            // button2
            // 
            button2.Location = new Point(540, 137);
            ...
            label2.TabIndex = 5;
            label2.Text = "Бочков Михаил Алексеевич ПРИ-120";
            // 
            // Form1
            // 
